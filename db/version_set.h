...
class VersionSet {
 public:
  ...
  CompactionL0* PickCompactionL0(MemTable *pmtable,std::vector<FileMetaData*>&input,InternalKey *all_start,InternalKey *all_limit,Version *current);
